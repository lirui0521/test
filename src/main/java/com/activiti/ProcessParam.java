...
public class ProcessParam {
	...
	public void deploymentProcessDefinition() {
		...
		Deployment deployment = processEngine.getRepositoryService()// 与流程定义和部署对象相关的Service
				...
				.name("请假流程带变量")// 添加部署的名称
				.addClasspathResource("diagrams/qingjia.bpmn")// 从classpath的资源中加载，一次只能加载一个文件
				.addClasspathResource("diagrams/qingjia.png")// 从classpath的资源中加载，一次只能加载一个文件
				.deploy(); // 完成部署
	...
	public void startProcessInstance() {
		...
		// 流程定义的key
		String processDefinitionKey = "qingjia_process2";
